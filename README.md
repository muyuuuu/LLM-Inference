<h1 align="center">LLM Inference :rocket: </h1>

<p align="center">
  <strong>从零实现大模型推理框架 — Qwen3 的本地部署与优化</strong>
</p>

由于好奇大模型推理的原理，学习了 [tiny-llm](https://skyzh.github.io/tiny-llm/week1-07-sampling-prepare.html) 课程并将苹果芯片相关代码适配 Nvidia 芯片。侧重 GPU 优化技术，完成 Qwen3-4B-Instruct-2507 模型的本地部署和推理加速。显存不够可以考虑 Qwen3-0.5B，主要是学技术。
